...
export const products: ProductPremium[] = [
  {
    ...
    knowledge: {
      ...
      crianza: "24 meses en barrica de roble americano",
      altitude: "600 m",
      servingTemperature: "16-18°C",
      agingPotential: "10-15 años",
      body: "Completo, estructurado",
      finish: "Largo y persistente con notas de vainilla y especias",
      tastingNotes: [
        "Notas de fruta negra madura",
        "Vainilla y especias de la barrica",
        "Taninos sedosos y bien integrados",
        "Final largo con recuerdos a regaliz",
      ],
      aromaProfile: [
        "Fruta negra (mora, grosella)",
        "Vainilla",
        "Cuero",
        "Tabaco",
        "Especias dulces",
  ...
  },
  {
    ...
    knowledge: {
      variety: "Viura 100%",
      crianza: "8 meses sobre lías en barrica de roble francés",
      altitude: "400 m",
      servingTemperature: "10-12°C",
      agingPotential: "3-5 años",
      body: "Medio, cremoso",
      finish: "Persistente con notas de fruta blanca y un sutil ahumado",
      tastingNotes: [
        "Fruta blanca madura (pera, manzana)",
        "Toques florales y cítricos",
        "Fondo de ahumado de la barrica",
        "Textura cremosa gracias a las lías",
      ],
      aromaProfile: [
        "Pera conferencia",
        "Manzana golden",
  ...
  },
  {
    ...
    knowledge: {
      ...
      body: "Medio-alto, fresco",
      finish: "Largo con notas de fruta roja y minerales",
      tastingNotes: [
        "Fruta roja silvestre (fresa, frambuesa)",
        "Notas minerales y de monte bajo",
        "Toques de especias dulces",
        "Acidez vibrante que aporta frescura",
      ],
      aromaProfile: [
        "Fresa silvestre",
        "Frambuesa",
  ...
  },
  {
    ...
    featured: true,
    knowledge: {
      oliveVariety: "Arbequina 100%",
      bitterness: "Baja",
      pungency: "Media-baja",
      intensity: "Frutado medio",
      aromaProfile: [
      ...
      tastingNotes: [
        "Entrada dulce y afrutada",
        "Ligero amargor final",
        "Picor muy suave y agradable",
      ],
      culinaryUses: [
        "Aliños de ensaladas",
        "Pescados blancos",
      ...
      idealFor: ["Cocina diaria", "Ensaladas", "Pescados"],
    },
  },
  {
    ...
    featured: false,
    knowledge: {
      oliveVariety: "Arbequina 60%, Picual 40%",
      bitterness: "Media",
      pungency: "Media",
      intensity: "Frutado intenso",
      aromaProfile: [
        "Hierba de monte",
        "Higo",
        "Alcachofa",
      ...
      tastingNotes: [
        "Ataque frutado intenso",
        "Amargor equilibrado",
        "Picor persistente pero armónico",
        "Final complejo con notas herbáceas",
      ],
      culinaryUses: [
        "Carnes blancas",
        "Verduras asadas",
      ...
      idealFor: ["Cocina de autor", "Platos contundentes", "Quesos"],
    },
  },
  {
    ...
    featured: true,
    knowledge: {
      floralOrigin: "Brezo (Erica spp.)",
      intensity: "Intensa",
      texture: "Densa, cremosa",
      sweetness: "Baja (ligeramente amarga)",
      aromaProfile: [
        "Madera de brezo",
        "Resina",
        "Flores silvestres",
      ...
      tastingNotes: [
        ...
        "Ligero amargor característico",
        "Notas a madera y resina",
        "Final largo con recuerdos a caramelo",
      ],
      recommendedUses: [
        "Quesos azules y curados",
        "Caza y carnes fuertes",
        "Chocolate negro (+70%)",
        "Tés negros e infusiones",
      ],
    },
  },
  {
    ...
    featured: false,
    knowledge: {
      floralOrigin: "Romero (Rosmarinus officinalis)",
      intensity: "Suave",
      texture: "Líquida",
      sweetness: "Alta (dulce natural)",
      aromaProfile: [
        "Flores de romero",
        "Cítricos (limón, naranja)",
        "Miel virgen",
        "Toques herbáceos suaves",
      ],
      tastingNotes: [
        "Dulce suave y agradable",
        "Notas cítricas frescas",
        "Final limpio y floral",
        "Textura líquida que se funde",
      ],
      recommendedUses: [
        "Tés e infusiones",
  ...
  },
  {
    ...
    knowledge: {
      tastingNotes: [
        "Anchoas en salazón con AOVE",
        "Bonito del norte en escabeche tradicional",
        "Pimientos asados al fuego",
        "Alcachofas confitadas en AOVE",
      ],
      aromaProfile: [
        "Anchoas: intenso y umami",
        "Bonito: escabeche clásico",
        "Pimientos: dulce y ahumado",
        "Alcachofas: terroso y suave",
      ],
      recommendedUses: [
        "Aperitivos y tapas",
        "Ensaladas",
  ...
  },
  {
    ...
    knowledge: {
      tastingNotes: [
        "Sabor intenso a almendra tostada",
        "Cacao puro que aporta profundidad",
        "AOVE arbequina que redondea el conjunto",
  ...
  },
  {
    ...
    featured: true,
    knowledge: {
      targetAudience: "Aficionados al vino que quieren explorar Rioja",
      occasion: "Iniciación a la cata, regalo para amantes del vino",
      premiumLevel: "Alto",
      includes: [
        "1 vino joven vibrante",
        "1 vino crianza equilibrado",
        "1 vino reserva con carácter",
        "Guía de cata ilustrada",
      ],
      recommendedFor: [
        "Regalo para amantes del vino",
        "Iniciación a la cata de Rioja",
        "Cena con amigos",
  ...
  },
  {
    ...
    featured: true,
    knowledge: {
      targetAudience: "Amantes de la gastronomía premium",
      occasion: "Cenas especiales, regalos corporativos",
      premiumLevel: "Premium",
      includes: [
        "1 botella de Reserva del Alto Ebro",
        "1 AOVE Arbequina Temprana 250ml",
        "3 conservas artesanas seleccionadas",
